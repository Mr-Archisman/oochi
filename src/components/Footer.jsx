...
function Footer() {
  return (
    <div className="w-full h-screen bg-zinc-900 p-14 flex">
      <div className=" relative w-1/2 h-full border-r-[1px] border-zinc-800">
        <h1 className="font-semibold tracking-tighter leading-none  text-[15vh] uppercase text-zinc-100 -mb-4">
          eye-
        </h1>
        <h1 className="font-semibold tracking-tighter leading-none  text-[15vh] uppercase   text-zinc-100">
          opening
        </h1>
        <div className="logo absolute left-0 bottom-0   ">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
